...
## The network stack
![tcp stack](http://www.steves-internet-guide.com/wp-content/uploads/osi-tcp-ip-models.jpg)
...
* Provides communication session management between host computers (client/server) using [TCP/UDP](http://microchipdeveloper.com/tcpip:tcp-vs-udp)
...
* Specifies details of how data is physically sent through the network (MAC address, cables, Wi-Fi)
