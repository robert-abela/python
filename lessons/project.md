...
## Task 3b - Web scraper
Select a website that you like which features search with advanced filtering options (e.g. [maltapark.com], [ebay.com], [graigslist.com]. [aliexpress.com], [imdb.com] etc.)
