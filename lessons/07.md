...
1. Open a text file and and count the occurences of every letter of the alphabet (both upper and lower case). Use a dictionary where the letters of the alphabet are the keys and the occurences of each letter are the values. Print out a summary at the end E.g.
~~~
A: 31
B: 30
C: 28
